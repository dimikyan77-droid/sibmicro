...
const translations = {
  ...
  "product.cross_refs": { en: "Cross References & Analogs", ru: "Аналоги и замены" },
  ...
  "product.tab_specs": { en: "Specifications", ru: "Характеристики" },
  "product.tab_docs": { en: "Documents", ru: "Документация" },
  "product.tab_analogs": { en: "Analogs", ru: "Аналоги" },
  "product.tab_pricing": { en: "Price Chart", ru: "График цен" },
  "product.documents": { en: "Documents & Datasheets", ru: "Документы и даташиты" },
  "product.download_pdf": { en: "Download PDF", ru: "Скачать PDF" },
  "product.datasheet_desc": { en: "Official manufacturer datasheet", ru: "Официальный даташит производителя" },
  "product.app_note": { en: "Application Note", ru: "Рекомендации по применению" },
  "product.app_note_desc": { en: "Design guidelines and application circuits", ru: "Руководство по проектированию и типовые схемы" },
  "product.errata": { en: "Errata", ru: "Список ошибок" },
  "product.errata_desc": { en: "Known issues and corrections", ru: "Известные проблемы и исправления" },
  "product.price_history": { en: "Price History (12 months)", ru: "История цен (12 месяцев)" },
  "product.price_per_unit": { en: "Price per unit, $", ru: "Цена за шт., $" },
  "product.no_analogs": { en: "No analogs found in catalog", ru: "Аналоги в каталоге не найдены" },
  "product.analog_match": { en: "match", ru: "совпадение" },
  "product.view_product": { en: "View", ru: "Посмотреть" },
  "product.copy_pn": { en: "Copy part number", ru: "Копировать артикул" },
  "product.copied": { en: "Copied!", ru: "Скопировано!" },
  "product.image_placeholder": { en: "Component image", ru: "Изображение компонента" },
  "product.ext_price": { en: "Ext. Price", ru: "Сумма" },
  ...
  // BOM page
  "bom.title": { en: "BOM Manager Pro", ru: "BOM-менеджер Pro" },
  "bom.subtitle": {
    en: "Upload your Bill of Materials — automatic component matching with pricing, availability, and alternatives.",
    ru: "Загрузите спецификацию материалов — автоматический подбор компонентов с ценами, наличием и альтернативами.",
  },
  ...
  "bom.no_file": { en: "No file loaded yet. Upload a CSV or Excel BOM to get started.", ru: "Файл пока не загружен. Загрузите CSV или Excel BOM для начала работы." },
  ...
  "bom.match_components": { en: "Match Components", ru: "Подобрать компоненты" },
  "bom.matching": { en: "Matching components...", ru: "Подбор компонентов..." },
  "bom.results": { en: "BOM Analysis Results", ru: "Результаты анализа BOM" },
  "bom.status": { en: "Status", ru: "Статус" },
  "bom.matched": { en: "Matched", ru: "Найден" },
  "bom.not_found": { en: "Not Found", ru: "Не найден" },
  "bom.alternative": { en: "Alternative", ru: "Альтернатива" },
  "bom.unit_price": { en: "Unit Price", ru: "Цена за шт." },
  "bom.ext_price": { en: "Ext. Price", ru: "Сумма" },
  "bom.stock": { en: "Stock", ru: "Наличие" },
  "bom.manufacturer": { en: "Manufacturer", ru: "Производитель" },
  "bom.alternatives": { en: "Alternatives", ru: "Альтернативы" },
  "bom.show_alts": { en: "Show alternatives", ru: "Показать альтернативы" },
  "bom.hide_alts": { en: "Hide alternatives", ru: "Скрыть альтернативы" },
  "bom.use_this": { en: "Use this", ru: "Использовать" },
  "bom.export_csv": { en: "Export CSV", ru: "Экспорт CSV" },
  "bom.export_xlsx": { en: "Export XLSX", ru: "Экспорт XLSX" },
  "bom.add_all_cart": { en: "Add All to Cart", ru: "Всё в корзину" },
  "bom.summary": { en: "Summary", ru: "Итого" },
  "bom.total_lines": { en: "Total lines", ru: "Всего позиций" },
  "bom.matched_lines": { en: "Matched", ru: "Найдено" },
  "bom.not_found_lines": { en: "Not found", ru: "Не найдено" },
  "bom.total_cost": { en: "Total cost", ru: "Общая стоимость" },
  "bom.select_alt": { en: "Select alternative", ru: "Выбрать альтернативу" },
  "bom.matched_count": { en: "matched", ru: "найдено" },
